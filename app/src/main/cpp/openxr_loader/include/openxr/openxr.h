...
typedef struct XrBodyJointLocationsBD {
    XrStructureType           type;
    void* XR_MAY_ALIAS        next;
    XrBool32                  allJointLocationsValid;
    uint32_t                  jointLocationCount;
...
typedef struct XrEyeTrackerDataInfoPICO {
    XrStructureType                type;
    const void* XR_MAY_ALIAS       next;
    const XrEyeTrackerFlagsPICO    eyeTrackingFlags;
...
typedef enum XrSecureMrModelEncodingPICO {
    ...
    XR_SECURE_MR_MODEL_ENCODING_INT_PICO = 2,
...
typedef enum XrSecureMrGltfOperatorAttributePICO {
    ...
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_METALLIC_FACTOR_PICO = 5,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_ROUGHNESS_FACTOR_PICO = 6,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_OCCLUSION_MAP_TEXTURE_PICO = 7,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_BASE_COLOR_FACTOR_PICO = 8,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_EMISSIVE_FACTOR_PICO = 9,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_EMISSIVE_STRENGTH_PICO = 10,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_EMISSIVE_TEXTURE_PICO = 11,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_BASE_COLR_TEXTURE_PICO = 12,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_NORMAL_MAP_TEXTURE_PICO = 13,
    XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_METALLIC_ROUGHNESS_TEXTURE_PICO = 14,
...
typedef enum XrSecureMrTensorBitTypePICO {
    XR_SECURE_MR_TENSOR_BIT_TYPE_UINT8_PICO = 1,
    XR_SECURE_MR_TENSOR_BIT_TYPE_INT8_PICO = 2,
    XR_SECURE_MR_TENSOR_BIT_TYPE_UINT16_PICO = 3,
    XR_SECURE_MR_TENSOR_BIT_TYPE_INT16_PICO = 4,
    XR_SECURE_MR_TENSOR_BIT_TYPE_INT32_PICO = 5,
    XR_SECURE_MR_TENSOR_BIT_TYPE_FLOAT32_PICO = 6,
    XR_SECURE_MR_TENSOR_BIT_TYPE_FLOAT64_PICO = 7,
    XR_SECURE_MR_TENSOR_BIT_TYPE_MAX_ENUM_PICO = 0x7FFFFFFF
} XrSecureMrTensorBitTypePICO;

typedef enum XrSecureMrTensorDataTypePICO {
    XR_SECURE_MR_TENSOR_DATA_TYPE_POINT_PICO = 1,
    XR_SECURE_MR_TENSOR_DATA_TYPE_SCALAR_PICO = 2,
    XR_SECURE_MR_TENSOR_DATA_TYPE_SLICE_PICO = 3,
    XR_SECURE_MR_TENSOR_DATA_TYPE_COLOR_PICO = 4,
    XR_SECURE_MR_TENSOR_DATA_TYPE_TIMESTAMP_PICO = 5,
    XR_SECURE_MR_TENSOR_DATA_TYPE_MAT_PICO = 6,
    XR_SECURE_MR_TENSOR_DATA_TYPE_GLTF_PICO = 7,
...
typedef struct XrSecureMrTensorFormatPICO {
    XrSecureMrTensorBitTypePICO     bitType;
    int8_t                          channel;
...
typedef XrFlags64 XrBodyTrackingPostureFlagsPICO;

// Flag bits for XrBodyTrackingPostureFlagsPICO
static const XrBodyTrackingPostureFlagsPICO XR_BODY_TRACKING_POSTURE_STOMP_BIT_PICO = 0x00000001;
static const XrBodyTrackingPostureFlagsPICO XR_BODY_TRACKING_POSTURE_STATIC_BIT_PICO = 0x00000002;
...
typedef struct XrBodyTrackingPostureFlagsDataPICO {
    ...
    void* XR_MAY_ALIAS                 next;
    uint32_t                           jointCount;
    XrBodyTrackingPostureFlagsPICO*    postureFlag;
