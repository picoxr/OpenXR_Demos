...
#define XR_LIST_ENUM_XrSecureMrModelEncodingPICO(_) \
    ...
    _(XR_SECURE_MR_MODEL_ENCODING_INT_PICO, 2) \
...
#define XR_LIST_ENUM_XrSecureMrGltfOperatorAttributePICO(_) \
    ...
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_METALLIC_FACTOR_PICO, 5) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_ROUGHNESS_FACTOR_PICO, 6) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_OCCLUSION_MAP_TEXTURE_PICO, 7) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_BASE_COLOR_FACTOR_PICO, 8) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_EMISSIVE_FACTOR_PICO, 9) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_EMISSIVE_STRENGTH_PICO, 10) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_EMISSIVE_TEXTURE_PICO, 11) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_BASE_COLR_TEXTURE_PICO, 12) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_NORMAL_MAP_TEXTURE_PICO, 13) \
    _(XR_SECURE_MR_GLTF_OPERATOR_ATTRIBUTE_METERIAL_METALLIC_ROUGHNESS_TEXTURE_PICO, 14) \
...
#define XR_LIST_ENUM_XrSecureMrTensorBitTypePICO(_) \
    _(XR_SECURE_MR_TENSOR_BIT_TYPE_UINT8_PICO, 1) \
    _(XR_SECURE_MR_TENSOR_BIT_TYPE_INT8_PICO, 2) \
    _(XR_SECURE_MR_TENSOR_BIT_TYPE_UINT16_PICO, 3) \
    _(XR_SECURE_MR_TENSOR_BIT_TYPE_INT16_PICO, 4) \
    _(XR_SECURE_MR_TENSOR_BIT_TYPE_INT32_PICO, 5) \
    _(XR_SECURE_MR_TENSOR_BIT_TYPE_FLOAT32_PICO, 6) \
    _(XR_SECURE_MR_TENSOR_BIT_TYPE_FLOAT64_PICO, 7) \
    _(XR_SECURE_MRTENSOR_BIT_TYPE_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrTensorDataTypePICO(_) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_POINT_PICO, 1) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_SCALAR_PICO, 2) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_SLICE_PICO, 3) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_COLOR_PICO, 4) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_TIMESTAMP_PICO, 5) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_MAT_PICO, 6) \
    _(XR_SECURE_MR_TENSOR_DATA_TYPE_GLTF_PICO, 7) \
...
#define XR_LIST_BITS_XrBodyTrackingPostureFlagsPICO(_) \
    _(XR_BODY_TRACKING_POSTURE_STOMP_BIT_PICO, 0x00000001) \
    _(XR_BODY_TRACKING_POSTURE_STATIC_BIT_PICO, 0x00000002) \
